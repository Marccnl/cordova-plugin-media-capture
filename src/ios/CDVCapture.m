...
- (void)captureVideo:(CDVInvokedUrlCommand*)command
{
	...
	// iOS 4.0		
        if ([pickerController respondsToSelector:@selector(cameraCaptureMode)]) {
            ...
            // pickerController.videoQuality = UIImagePickerControllerQualityTypeHigh;		            // pickerController.videoQuality = UIImagePickerControllerQualityTypeHigh;
            // pickerController.cameraDevice = UIImagePickerControllerCameraDeviceRear;		            // pickerController.cameraDevice = UIImagePickerControllerCameraDeviceRear;
            // pickerController.cameraFlashMode = UIImagePickerControllerCameraFlashModeAuto;		            // pickerController.cameraFlashMode = UIImagePickerControllerCameraFlashModeAuto;
        }
        // CDVImagePicker specific property
        pickerController.callbackId = callbackId;
        pickerController.modalPresentationStyle = UIModalPresentationCurrentContext;
